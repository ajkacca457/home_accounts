import {
    SHOW_ALERT, CLEAR_ALERT, REGISTER_USER_BEGIN, REGISTER_USER_SUCCESS,
...
const GlobalReducer = (state, action) => {
    switch (action.type) {
        ...
        case CHANGE_PAGE:
            if (action.payload.name === "income") {
                return {
                    ...state, incomepage: action.payload.pageNum
                };
            }
            if (action.payload.name === "expense") {
                return {
