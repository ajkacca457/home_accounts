...
const {logOutUser}= useGlobalContext();
  ...
  return (
    <div className='mobile-navigation block lg:hidden items-center gap-[2rem]'>
        <button onClick={handleNav} className='w-2/6 text-center text-white bg-zinc-400 rounded flex items-center justify-center py-1 my-2'>{showNav?<RiCloseFill/>:<ImMenu/>}Menu</button>
